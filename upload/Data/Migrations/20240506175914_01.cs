    ...
    public partial class _01 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Thumbnails", x => x.Type);
                    table.ForeignKey(
                        name: "FK_Thumbnails_Files_StoredFileId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { new Guid("e2760bc3-e0cf-48fc-8be8-0d195eda4663"), null, "moderator", "MODERATOR" }
                });

            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "AccessFailedCount", "ConcurrencyStamp", "Email", "EmailConfirmed", "FullName", "LockoutEnabled", "LockoutEnd", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "SecurityStamp", "TwoFactorEnabled", "UserName" },
                values: new object[] { new Guid("11111111-1111-1111-1111-111111111111"), 0, "d45d96b2-15d1-443f-a14c-6c4b24923462", "admin@local.slhn.cz", true, "Administrator User", false, null, "ADMIN@LOCAL.SLHN.CZ", "ADMIN", "AQAAAAIAAYagAAAAEOtaT3T5T2GgZkr6TBHoNj7DEXxWy08BwAJboAeY3j1AQJWhwXGt36BMFbS3kxNJVw==", null, false, "Asdfiasjfisda", false, "admin" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Thumbnails_StoredFileId",
                table: "Thumbnails",
                column: "StoredFileId");
